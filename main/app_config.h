...
#define OTA_FW_VERSION      0x01000008   /* 1.0.0.8 - active OTA query bootstrap */
...
#define OTA_SERVER_ADDR     0x0000       /* coordinator short address    */
#define OTA_SERVER_ENDPOINT 1            /* Zigbee2MQTT coordinator ep   */
#define OTA_QUERY_DELAY_MS  15000        /* first check after join       */
